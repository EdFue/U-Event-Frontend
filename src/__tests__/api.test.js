...
describe("API", () => {
  ...
  it("fetchAndSetImageBase64 should return base64 image string on successful fetch", async () => {
    ...
    fetchStub
      .withArgs("https://u-event-backend-d86136b87ee9.herokuapp.com/images/imageId")
      .returns(Promise.resolve(mockResponse));
  ...
  it("fetchInterests should return interests on successful fetch", async () => {
    ...
    fetchStub
      .withArgs("https://u-event-backend-d86136b87ee9.herokuapp.com/api/interests")
      .returns(Promise.resolve(mockResponse));
  ...
  it("fetchUserInterests should return user interests on successful fetch", async () => {
    ...
    fetchStub
      .withArgs("https://u-event-backend-d86136b87ee9.herokuapp.com/api/interests/username/username")
      .returns(Promise.resolve(mockResponse));
